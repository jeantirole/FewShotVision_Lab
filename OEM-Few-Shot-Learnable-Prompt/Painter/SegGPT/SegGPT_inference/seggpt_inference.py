...
def get_args_parser():
    ...
    parser.add_argument('--ckpt_path', type=str, help='path to ckpt',
                        default='/home/eric/data/weight/seggpt_vit_large.pth')
    ...
    parser.add_argument('--input_image', type=str, help='path to input image to be tested',
                        default="/home/eric/srcs/FewShotSeg_Lab/FewShotVision_Lab/OEM-Few-Shot-Learnable-Prompt/Painter/SegGPT/SegGPT_inference/examples/hmbb_2.jpg")
    ...
    parser.add_argument('--prompt_image', type=str, nargs='+', help='path to prompt image',
                        default="/home/eric/srcs/FewShotSeg_Lab/FewShotVision_Lab/OEM-Few-Shot-Learnable-Prompt/Painter/SegGPT/SegGPT_inference/examples/hmbb_1.jpg")
    parser.add_argument('--prompt_target', type=str, nargs='+', help='path to prompt target',
                        default="/home/eric/srcs/FewShotSeg_Lab/FewShotVision_Lab/OEM-Few-Shot-Learnable-Prompt/Painter/SegGPT/SegGPT_inference/examples/hmbb_1_target.png")
    ...
    parser.add_argument('--output_dir', type=str, help='path to output',
                        default='/home/eric/srcs/FewShotSeg_Lab/FewShotVision_Lab/OEM-Few-Shot-Learnable-Prompt/Painter/SegGPT/SegGPT_inference/outputs')
...
if __name__ == '__main__':
    ...
    if args.input_image is not None:
        ...
        #print("args.input_image",args.input_image)
        #print("args.prompt_image",args.prompt_image)
